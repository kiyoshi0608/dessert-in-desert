...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ja: {
            ...
            'review-track-1': '長く生きるということは、別れを重ねるということでもあります。<br>そのたびに大きな悲しみと寂しさに胸が痛くなりますが、最後に残る言葉はいつも「ありがとう」でした。<br>生きている今だからこそ、ありがとうという言葉をたくさん伝え合っていきたい。<br>これを読んでくれたあなたにも、ありがとう。',
            'review-track-2': 'この曲は僕らの待ち合わせ場所の歌です。<br>どんなバカでも天才でも、生まれた国や地域がどこであっても、<br>コミュ症でも、酒クズでも、ドジでも、地味でも奇抜でも、トラウマがあっても、凸凹でも、<br>ここに集まればみんな一緒にハッピーになれる！<br>それが僕らの音の鳴る待ち合わせ場所を作りたい！',
            'review-track-3': '清志郎さんのおかげで日本のロックをより心から大好きになり、今もバンドを続けることができています。<br>「REMEMBER YOU」がリリースされ初めて聴いたとき、優しさと切なさ、そして温かさに胸がいっぱいになり、思わず涙が溢れ出ました。<br>いつかカバーしたいな〜と思い続けてきましたが、敬愛の思いが強すぎて踏み出すタイミングをずっと先延ばししてきました。<br>この度、原曲への最大限の敬意をもって、楽器の素晴らしさを損なわないアレンジでカバーさせていただきました！',
            'review-track-4': '道を歩いてて石ころに足をつまずいて転けてしまった！<br>膝が痛い！そしてめっちゃびっくしして声も出た！<br>でも、、、それより何よりすごい恥ずかしい。。。<br>穴があったら入りたい、でももう時間は巻き戻せない。。。<br>そんな時は、そう、、何事もなかった顔して、平然を装うんだ。<br>内心心臓がバクバクで膝も痛い。。でもここでリアクションとってしまったら恥ずかしい。。<br>だから、今日も僕は何事もなかった顔をするんだ。',
            'review-track-5': '不安で逃げ出しそうになっても、<br>最後に自分を奮い立たせるのは他でもない自分自身！<br>誰に何を言われても、自分が信じた道なら自分を信じて突き進んでいこう！<br>絶対なんてそんな言葉は存在しない<br>その可能性を持っているのは他の誰でもない君自身だ！<br><br>ここ一番で心を奮い立たせたい時に、<br>爆音で聞いてください！',
            'review-track-6': 'この曲は、子供の頃に感じていた戸惑いや「みんなと同じようにできない」と感じていた気持ちから生まれた一曲です。<br>うまく言葉にできない不安や、心の中にしまっていた小さな痛み。<br>その中で、そばにいた親にもたくさん心配をかけ、不安にさせてしまったと思います。<br>この曲が、同じような悩みを抱えている人はもちろん、その人を支えている家族や周りの人の心にも、少しでもやさしく寄り添えたら嬉しいです。<br>すぐに答えが出る歌ではないけれど、雨の中にほんの少し光が差すような、そんな一曲になればと思っています。<br><a href="https://note.com/kiyoshi_saboten/n/nf95f6a3f5796?sub_rt=share_pw" target="_blank" rel="noopener" class="note-link">さらに想いを知りたい方はこちら✅</a>',
            'review-track-7': '十六歳の春、高校の校庭で初めて聞いたバンドサウンド。<br>その音はまるで落雷のように僕の全身に衝撃を与えました⚡︎<br>あの時の衝撃は今も全身を駆け巡り続けて、現在進行形で燃え続けています。<br>あの頃を青春と呼ぶのなら、さらに加熱し続けてる今を“赤春”と呼ぼう！',
        ...
        en: {
            ...
            'track-6': 'The Bud',
            'track-7': 'Sekishun',
            'comment-kiyoshi': "For this album, we set out to create songs that stay close to people's emotions—through joy, anger, sadness, and everything in between.<br><br>We carefully chose each track so the album would feel balanced, never too heavy and never too light.<br><br>During recording, the band felt incredibly relaxed, and we think that atmosphere naturally comes through in the sound.<br><br>Rather than relying on excessive production, we focused on keeping the performances as natural as possible so you can really feel the band's atmosphere.<br><br>We hope you enjoy what we believe is SABOTEN's finest work yet, now in our 27th year as a band.<br><a href=\"https://note.com/kiyoshi_saboten/n/neda688311c46?sub_rt=share_sb\" target=\"_blank\" rel=\"noopener\" class=\"note-link\">Read more about my thoughts (Japanese)✅</a>",
            ...
            'review-track-1': 'Living a long life also means experiencing many goodbyes.<br>Each time, the heart aches with great sadness and loneliness, but the word that always remains at the end is "Thank you."<br>Precisely because we are alive now, I want us to share those words with each other as much as possible.<br>To you who are reading this, thank you.',
            'review-track-2': "To put it simply, this song is about our meeting place.<br>No matter if you're a fool or a genius, no matter where you were born,<br>whether you have social anxiety, are a heavy drinker, clumsy, plain or eccentric, have trauma, or are a bit rough around the edges—<br>if we gather here, we're all the same and we can all be happy together.<br>That is our meeting place where the sound rings out!",
            'review-track-3': 'Thanks to Kiyoshiro-san, I came to love music and rock even more from the bottom of my heart, and I\'ve been able to keep going until now.<br>When "REMEMBER YOU" was released and I heard it for the first time, my heart was filled with kindness, sadness, and warmth, and tears unexpectedly flowed.<br>I had always wanted to cover it someday, but my feelings of respect were so strong that I kept putting off the right time to take that step.<br>This time, with the utmost respect for the original song, I have expressed it with an arrangement that respects and preserves the brilliance of the instruments!',
            'review-track-4': "You’re walking down the street, and suddenly you trip over a little stone and fall.<br><br>Your knee hurts.<br>You’re shocked.<br>You even let out a voice without meaning to.<br><br>But more than anything…<br>it’s embarrassing.<br><br>You wish you could disappear into a hole in the ground,<br>but there’s no way to rewind time.<br><br>So in a moment like that, there’s only one thing to do.<br><br>Put on a face that says nothing happened.<br>Act calm.<br>Walk like everything is totally fine.<br><br>Inside, your heart is pounding.<br>Your knee still hurts.<br>But if you react now, it only gets more embarrassing.<br><br>So today again,<br>I put on my “as if nothing happened” face.",
            'review-track-5': "Even when anxiety makes you want to run away,<br>the one who gives you the final push is no one else but yourself.<br><br>No matter what anyone says,<br>if it’s the path you believe in,<br>trust yourself and keep moving forward.<br><br>There is no such thing as “absolute.”<br><br>The only one who holds that possibility<br>is you.<br><br>When you need to light a fire in your heart<br>and push yourself forward at the most important moment,<br>turn this song up loud and let it hit you.",
            'review-track-6': "This song was born from the confusion I felt as a child,<br>and the feeling that I couldn’t do things the same way as everyone else.<br><br>The anxiety I couldn’t put into words.<br>The small pains I kept hidden deep inside my heart.<br><br>Looking back, I think I also made my parents worry a lot,<br>and caused them to feel uneasy many times.<br><br>I hope this song can gently stay close<br>not only to those who are carrying similar struggles,<br>but also to the families and people around them who are supporting them.<br><br>It may not be a song that gives you an immediate answer.<br><br>But I hope it can become a song like a small ray of light<br>shining through the rain.<br><br><a href=\"https://note.com/kiyoshi_saboten/n/nf95f6a3f5796?sub_rt=share_pw\" target=\"_blank\" rel=\"noopener\" class=\"note-link\">For those who would like to know more about the thoughts behind this song✅</a>",
            'review-track-7': "At sixteen, one spring day,<br>I heard a band sound for the first time in my high school schoolyard.<br><br>That sound hit my whole body like a bolt of lightning⚡︎<br><br>The shock I felt that day is still running through me,<br>still burning inside me even now.<br><br>If those days are called “youth,”<br>then this present, still heating up and burning even brighter,<br>should be called “ Sekishun” — Red Spring.",
